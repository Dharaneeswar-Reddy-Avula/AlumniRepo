        ...
        <div className="flex flex-col gap-[4px]">
          ...
          {isOpen && (
            <div className="flex flex-col gap-[10px] pt-[10px]">
              ...
              <Link 
              to ="/Collagedays"
              className={`mt-[15px] tab ${location.pathname==="/Collagedays"?"active text-blue-500":""}`}>
                Collagedays
              </Link>
              <Link 
              to ="/Video"
              ...
              <Link 
              to ="/Festival"
              className={`mt-[25px] tab ${location.pathname==="/Festivals"?"active":""}`}>
                Festivals
              </Link>
            </div>
          )}
